        ...
        public class SMPPClient
        {
                                ...
                                byte[] message, int msgID)
            {
                try
                {
                    ...
                    _SUBMIT_SM_PDU[pos] = 0x00; // Сообщение передается через message_payload, поэтому sm_length = 0
                    pos += 1;
                    // short_massage опускаем                    
                    // TLV message_payload
                    // Parameter Tag                    
                                ...
                                {                                	
                                    ...
                                    switch (_command_id)
                                    {
                                        case 0x80000009:
                                            ...
                                            break;
                                        case 0x80000004:
                                            logMessage(LogLevels.LogSteps, "Получен пакет: Submit_Sm_Resp");
                                            logMessage(LogLevels.LogSteps, "Статус команды: " + _command_status.ToString("X8"));
                                            ...
                                            logMessage(LogLevels.LogSteps, "Содержание: " + Tools.ConvertArrayToHexString(_PDU_body, _PDU_body.Length));
                                            logMessage(LogLevels.LogSteps, "Содержание: " + Tools.ConvertArrayToString(_PDU_body, _PDU_body.Length));                                            
