...
namespace SMSCenter
{
    public class Tools
    {
        ...
        public static void CopyIntToArrayTwoOctet(int x, byte[] ar, int pos)
        {
            byte[] arTmp;
            ConvertIntToArrayTwoOctet(x, out arTmp);
            Array.Copy(arTmp, 0, ar, pos, 2);
        }
        
        public static void ConvertIntToArrayTwoOctet(int x, out byte[] ar)
        {
            ar = new byte[4];
