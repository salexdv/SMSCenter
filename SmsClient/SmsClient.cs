...
namespace SMSCenter
{
    public class SmsClient
    {
        ...
        {
        	// Получено подтверждение того, что отправленное сообщение
        	// получено SMPP, сохраним его uin
        	...
        	{        		
        		...
        		else
        		{
	        		...
	        		{
		        		Notification.AddEventToLog("Не удалось сохранить статус сообщения: " + SQL.TextStatus, true);        		
	        		}
        		}
        	}
